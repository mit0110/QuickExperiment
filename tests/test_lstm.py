...
class LSTMModelTest(unittest.TestCase):
    ...
    def test_build_network(self):
        ...
        model = self.MODEL(self.dataset, **self.model_arguments)
    ...
    def test_fill_feed_dict(self):
        ...
        model = self.MODEL(self.dataset, max_num_steps=self.max_num_steps,
                               **self.model_arguments)
        model.build_all()
...
class BiLSTMModelTest(LSTMModelTest):

    MODEL = bi_lstm.BiLSTMModel
